...
import (
	...
	"github.com/rajvikram/prometheus/v2/discovery"
	"github.com/rajvikram/prometheus/v2/discovery/azure"
	"github.com/rajvikram/prometheus/v2/discovery/consul"
	"github.com/rajvikram/prometheus/v2/discovery/digitalocean"
	"github.com/rajvikram/prometheus/v2/discovery/dns"
	"github.com/rajvikram/prometheus/v2/discovery/dockerswarm"
	"github.com/rajvikram/prometheus/v2/discovery/ec2"
	"github.com/rajvikram/prometheus/v2/discovery/eureka"
	"github.com/rajvikram/prometheus/v2/discovery/file"
	"github.com/rajvikram/prometheus/v2/discovery/hetzner"
	"github.com/rajvikram/prometheus/v2/discovery/kubernetes"
	"github.com/rajvikram/prometheus/v2/discovery/marathon"
	"github.com/rajvikram/prometheus/v2/discovery/openstack"
	"github.com/rajvikram/prometheus/v2/discovery/targetgroup"
	"github.com/rajvikram/prometheus/v2/discovery/triton"
	"github.com/rajvikram/prometheus/v2/discovery/zookeeper"

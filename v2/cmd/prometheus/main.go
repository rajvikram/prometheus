...
import (
	...
	_ "github.com/rajvikram/prometheus/v2/discovery/install" // Register service discovery implementations.
	"github.com/rajvikram/prometheus/v2/notifier"
	"github.com/rajvikram/prometheus/v2/pkg/labels"
	"github.com/rajvikram/prometheus/v2/pkg/logging"
	"github.com/rajvikram/prometheus/v2/pkg/relabel"
	prom_runtime "github.com/rajvikram/prometheus/v2/pkg/runtime"
	...
	"github.com/rajvikram/prometheus/v2/web"
)
...
func main() {
	...
	a.Flag("scrape.adjust-timestamps", "Adjust scrape timestamps by up to 2ms to align them to the intended schedule. See https://github.com/rajvikram/prometheus/v2/issues/7846 for more context. Experimental. This flag will be removed in a future release.").

...
import (
	...
	"github.com/rajvikram/prometheus/v2/template"
	...
	api_v1 "github.com/rajvikram/prometheus/v2/web/api/v1"
	"github.com/rajvikram/prometheus/v2/web/ui"
)
...
func New(logger log.Logger, o *Options) *Handler {
	...
	// See https://github.com/rajvikram/prometheus/v2/issues/6163#issuecomment-553855129.
	router.Get("/classic", func(w http.ResponseWriter, r *http.Request) {
